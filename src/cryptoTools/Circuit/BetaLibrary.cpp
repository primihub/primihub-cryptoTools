...
#include "src/cryptoTools/Crypto/RandomOracle.h"
...
namespace primihub::osuCrypto
{
	...
	BetaCircuit* primihub::osuCrypto::BetaLibrary::int_int_add(u64 aSize, u64 bSize, u64 cSize, Optimized op)
	{
	...
	BetaCircuit* primihub::osuCrypto::BetaLibrary::int_int_add_msb(u64 aSize, Optimized op)
	{
