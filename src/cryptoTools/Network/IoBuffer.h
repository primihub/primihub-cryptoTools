...
namespace boost {
    namespace system {
        template <>
        struct is_error_code_enum<primihub::osuCrypto::Errc> : true_type {};
    }
}

namespace primihub::osuCrypto { // anonymous namespace
    ...
    struct osuCryptoErrCategory : boost::system::error_category
    {
        ...
        {
            switch (static_cast<primihub::osuCrypto::Errc>(ev))
            {
            case primihub::osuCrypto::Errc::success:
                return "Success";

            // case primihub::osuCrypto::Errc::CloseChannel:
