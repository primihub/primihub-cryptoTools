...
namespace boost {
    namespace system {
        template <>
        struct is_error_code_enum<primihub::osuCrypto::WolfSSL_errc> : true_type {};
        template <>
        struct is_error_code_enum<primihub::osuCrypto::TLS_errc> : true_type {};
    }
}
...
namespace { // anonymous namespace
    ...
    struct TLSErrCategory : boost::system::error_category
    {
        ...
        std::string message(int err) const override
        {
            switch (static_cast<primihub::osuCrypto::TLS_errc>(err))
            {
            case primihub::osuCrypto::TLS_errc::Success:
                return "Success";
            case primihub::osuCrypto::TLS_errc::Failure:
                return "Generic Failure";
            case primihub::osuCrypto::TLS_errc::ContextNotInit:
                return "TLS context not init";
            case primihub::osuCrypto::TLS_errc::ContextAlreadyInit:
                return "TLS context is already init";
            case primihub::osuCrypto::TLS_errc::ContextFailedToInit:
                return "TLS context failed to init";
            case primihub::osuCrypto::TLS_errc::OnlyValidForServerContext:
                return "Operation is only valid for server initialized TLC context";
            case primihub::osuCrypto::TLS_errc::SessionIDMismatch:
