...
namespace primihub::osuCrypto
{
    ...
    void primihub::osuCrypto::WolfSocket::setDHParamFile(std::string path, error_code& ec)
    {
    ...
    void primihub::osuCrypto::WolfSocket::setDHParam(span<u8> data, error_code& ec)
    {
        ec = wolfssl_error_code(
            wolfSSL_SetTmpDH_buffer(mSSL, data.data(), static_cast<long>(data.size()), WOLFSSL_FILETYPE_PEM));
    }

    WolfCertX509 primihub::osuCrypto::WolfSocket::getCert()
    {
