...
#include "src/cryptoTools/Common/BitIterator.h"
#include "src/cryptoTools/Crypto/PRNG.h"
#include "src/cryptoTools/Network/IoBuffer.h"
...
namespace primihub::osuCrypto {
    ...
    inline ph_oc::u64 u8Size(ph_oc::BitVector& bv)
    {
        return bv.sizeBytes();
    }
    inline ph_oc::u64 u8Size(const ph_oc::BitVector& bv)
    {
        return bv.sizeBytes();
    }
}
