...
#include <sstream>
#include <vector>
#include "src/cryptoTools/Crypto/AES.h"
...
std::ostream& operator<<(std::ostream& out, const ph_oc::block& blk)
{
...
namespace
{
    ph_oc::AES defaultBlockHasher(ph_oc::block(4632453, 57432));
}

std::size_t std::hash<ph_oc::block>::operator()(const ph_oc::block& k) const
{
