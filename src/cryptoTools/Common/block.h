...
namespace primihub::osuCrypto
{
	struct alignas(16) block
	{
		...
		OC_FORCEINLINE  primihub::osuCrypto::block operator^(const primihub::osuCrypto::block& rhs) const
		{
#ifdef OC_ENABLE_SSE2
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  primihub::osuCrypto::block mm_xor_si128(const primihub::osuCrypto::block& rhs) const
		{
			return _mm_xor_si128(*this, rhs);
		}
#endif
		OC_FORCEINLINE  primihub::osuCrypto::block cc_xor_si128(const primihub::osuCrypto::block& rhs) const
		{
		...
		OC_FORCEINLINE  primihub::osuCrypto::block& operator^=(const primihub::osuCrypto::block& rhs)
		{
			*this = *this ^ rhs;
			return *this;
		}
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  primihub::osuCrypto::block mm_and_si128(const primihub::osuCrypto::block& rhs)const
		{
			return _mm_and_si128(*this, rhs);
		}
#endif
		OC_FORCEINLINE  primihub::osuCrypto::block cc_and_si128(const primihub::osuCrypto::block& rhs)const
		{
			auto ret = get<std::uint64_t>();
			auto rhsa = rhs.get<std::uint64_t>();
			ret[0] &= rhsa[0];
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  primihub::osuCrypto::block mm_or_si128(const primihub::osuCrypto::block& rhs)const
		{
			return _mm_or_si128(*this, rhs);
		}
#endif
		OC_FORCEINLINE  primihub::osuCrypto::block cc_or_si128(const primihub::osuCrypto::block& rhs)const
		{
			auto ret = get<std::uint64_t>();
			auto rhsa = rhs.get<std::uint64_t>();
			ret[0] |= rhsa[0];
		...
		OC_FORCEINLINE  primihub::osuCrypto::block operator<<(const std::uint8_t& rhs)const
		{
#ifdef OC_ENABLE_SSE2
		...
		OC_FORCEINLINE  primihub::osuCrypto::block& operator<<=(const std::uint8_t& rhs)
		{
			*this = *this << rhs;
			return *this;
		}
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  primihub::osuCrypto::block mm_slli_epi64(const std::uint8_t& rhs)const
		{
			return _mm_slli_epi64(*this, rhs);
		}
#endif
		OC_FORCEINLINE  primihub::osuCrypto::block cc_slli_epi64(const std::uint8_t& rhs)const
		{
			auto ret = get<std::uint64_t>();
			ret[0] <<= rhs;
			ret[1] <<= rhs;
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  block mm_add_epi64(const primihub::osuCrypto::block& rhs) const
		{
			return _mm_add_epi64(*this, rhs);

		}
#endif
		OC_FORCEINLINE  block cc_add_epi64(const primihub::osuCrypto::block& rhs) const
		{
			auto ret = get<std::uint64_t>();
			auto rhsa = rhs.get<std::uint64_t>();
			ret[0] += rhsa[0];
...
#ifdef OC_ENABLE_SSE2
		OC_FORCEINLINE  block mm_sub_epi64(const primihub::osuCrypto::block& rhs) const
		{
			return _mm_sub_epi64(*this, rhs);

		}
#endif
		OC_FORCEINLINE  block cc_sub_epi64(const primihub::osuCrypto::block& rhs) const
		{
			auto ret = get<std::uint64_t>();
			auto rhsa = rhs.get<std::uint64_t>();
			ret[0] -= rhsa[0];
		...
		OC_FORCEINLINE  block& cmov(const primihub::osuCrypto::block& rhs, bool cond);

		// Same, but expects cond to be either 0x00 or 0xff.
		OC_FORCEINLINE  block& cmovBytes(const primihub::osuCrypto::block& rhs, uint8_t cond);

		OC_FORCEINLINE  bool operator==(const primihub::osuCrypto::block& rhs) const
		{
#ifdef OC_ENABLE_SSE2
	...
	OC_FORCEINLINE  block& block::cmov(const primihub::osuCrypto::block& rhs, bool cond)
	{
		return *this ^= allSame(cond) & (*this ^ rhs);
	}

	OC_FORCEINLINE  block& block::cmovBytes(const primihub::osuCrypto::block& rhs, uint8_t cond)
	{
		return *this ^= allSame(cond) & (*this ^ rhs);
	}
...
std::ostream& operator<<(std::ostream& out, const primihub::osuCrypto::block& block);
namespace primihub::osuCrypto
{
	using ::operator<<;
}

OC_FORCEINLINE  bool eq(const primihub::osuCrypto::block& lhs, const primihub::osuCrypto::block& rhs)
{
	return lhs == rhs;
}

OC_FORCEINLINE  bool neq(const primihub::osuCrypto::block& lhs, const primihub::osuCrypto::block& rhs)
{
	return lhs != rhs;
}
...
namespace std {
	...
	template <>
	struct hash<primihub::osuCrypto::block>
	{
		std::size_t operator()(const primihub::osuCrypto::block& k) const;
	};
