...
namespace primihub::osuCrypto
{
        ...
        {
            return primihub::osuCrypto::detail::countl_impl(x);
        }
        ...
        namespace detail
        {
            ...
            inline int countl_impl(std::uint64_t x) noexcept
            {
                ...
                return static_cast<std::uint32_t>(x >> 32) != 0 ?
                    primihub::osuCrypto::detail::countl_impl(static_cast<std::uint32_t>(x >> 32)) :
                    primihub::osuCrypto::detail::countl_impl(static_cast<std::uint32_t>(x)) + 32;
            ...
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint32_t>(x)) - 24;
            }

            inline int countl_impl(std::uint16_t x) noexcept
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint32_t>(x)) - 16;
            }
        ...
        int countl_zero(T x) noexcept
        {
            ...
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint8_t>(x));
            }
            else if (sizeof(T) == sizeof(std::uint16_t))
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint16_t>(x));
            }
            else if (sizeof(T) == sizeof(std::uint32_t))
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint32_t>(x));
            }
            else
            {
                return primihub::osuCrypto::detail::countl_impl(static_cast<std::uint64_t>(x));
            }
        }
        ...
        {
            return primihub::osuCrypto::countl_zero(static_cast<T>(~x));
        }
        ...
        {
            return primihub::osuCrypto::detail::countr_impl(x);
        }
        ...
        namespace detail
        {
            ...
            inline int countr_impl(std::uint64_t x) noexcept
            {
                ...
                return static_cast<std::uint32_t>(x) != 0 ?
                    primihub::osuCrypto::detail::countr_impl(static_cast<std::uint32_t>(x)) :
                    primihub::osuCrypto::detail::countr_impl(static_cast<std::uint32_t>(x >> 32)) + 32;
            ...
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint32_t>(x) | 0x100);
            }

            inline int countr_impl(std::uint16_t x) noexcept
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint32_t>(x) | 0x10000);
            }
        ...
        int countr_zero(T x) noexcept
        {
            ...
            if (sizeof(T) == sizeof(std::uint8_t))
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint8_t>(x));
            }
            else if (sizeof(T) == sizeof(std::uint16_t))
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint16_t>(x));
            }
            else if (sizeof(T) == sizeof(std::uint32_t))
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint32_t>(x));
            }
            else
            {
                return primihub::osuCrypto::detail::countr_impl(static_cast<std::uint64_t>(x));
            }
        }
        ...
        {
            return primihub::osuCrypto::countr_zero(static_cast<T>(~x));
        }
...
#undef OC_POPCOUNT_CONSTEXPR
        ...
        {
            return primihub::osuCrypto::detail::popcount_impl(x);
        }
        ...
        constexpr int popcount(T x) noexcept
        {
            ...
            {
                return primihub::osuCrypto::detail::popcount_impl(static_cast<std::uint32_t>(x));
            }
            else
            {
                return primihub::osuCrypto::detail::popcount_impl(static_cast<std::uint64_t>(x));
            }
        }
        ...
        {
            return std::numeric_limits<T>::digits - primihub::osuCrypto::countl_zero(x);
        }

        template<class T>
        constexpr T bit_floor(T x) noexcept
        {
            return x == 0 ? 0 : T(1) << (primihub::osuCrypto::bit_width(x) - 1);
        }
        ...
        constexpr T bit_ceil(T x) noexcept
        {
            ...
            if (sizeof(T) <= sizeof(std::uint32_t))
            {
                return static_cast<T>(primihub::osuCrypto::detail::bit_ceil_impl(static_cast<std::uint32_t>(x)));
            }
            else
            {
                return static_cast<T>(primihub::osuCrypto::detail::bit_ceil_impl(static_cast<std::uint64_t>(x)));
            }
        }
